...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen lg:h-screen bg-[#0e0e0e] flex items-center justify-center overflow-hidden pb-5 sm:pb-8 lg:pb-0">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center relative z-10 mt-2">
          ...
          >
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-relaxed max-w-lg">
              Passionate full-stack enthusiast focused on crafting clean,
              responsive, and elegant digital experiences. Specializing in
              modern React, Next.js, and Node.js ecosystems to deliver highly
          ...
          >
            ...
            >
              ...
              <FaArrowDown className="text-sm animate-gentle group-hover:translate-y-0.5 transition-transform duration-200" />
