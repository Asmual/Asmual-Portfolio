...
const projects = [
  {
    ...
    image: "/images/gamehub.png", // Replace with your image path
  ...
  },
  {
    ...
    image: "/images/googledocs.png", // Replace with your image path
  ...
  },
  {
    ...
    image: "/images/googledrive.png", // Replace with your image path
...
export default function Projects() {
  return (
    <section className="relative bg-[#0e0e0e] text-white py-24 overflow-hidden">
